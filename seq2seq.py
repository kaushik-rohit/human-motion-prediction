...
import copy
import util.rnn_cell_extensions as rnn_cell_extensions


from tf_models import BaseModel
...
class seq2seq(BaseModel):
    ...
    def build_network(self):
        ...
        print(self.config['cell_type'], self.config.get("input_dropout_rate", 0), self.input_layer_size, self.residual_velocity, self.architecture)
        ...
        self.outputs=  tf.transpose(tf.stack(outputs), (1, 0, 2))  # (N, seq_length, n_joints*dof)
        self.build_loss()
    ...
    def get_model_config(cls, args, from_config=None):
        ...
        """
        config, experiment_name = super(seq2seq, cls).get_model_config(args, from_config)
